        ...
        <View style={styles.container}>
            {isLoading ? <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
                ...
                <View style={styles.parent}>
                    ...
                    <View style={styles.inst} ><Text style={styles.instText}>

                        Select an option to move to next question or skip the question!..Remember you cannot come back to question once you skipped it</Text></View>
